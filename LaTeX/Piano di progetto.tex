...
\begin{document}
	...
	\mychapter{2}{Pianificazione}
		...
		\begin{itemize}
			...
			\emph{Gantt} con il colore verde;
			\item \textbf{Neutro:} \emph{Task} a media criticità, possono essere svolti in parallelo ad altri \emph{Task}, ma 
			un eventuale ritardo in uno di questi provocherebbe slittamenti sulle dipendenze. Nel \emph{Gantt} sono indicati 
