...
\begin{document}
	...
	\section{Organigramma}
		...
		\end{table}
		\subsection{Accetazione componenti}
		\begin{table}[H]
			\begin{tabularx}{\textwidth}{Y Y Y}
				\noalign{\hrule height 1.5pt}
	...
	\section{Introduzione}
		...
		\subsection{Ciclo di vita}
			Il gruppo ha deciso, unanimemente di adottare il \textbf{modello incrementale} come modello di ciclo di vita.
	...
	\section{Analisi dei rischi}
		...
		\subsection{Livello tecnologico}
			\subsubsection{Tecnologie adottate}
				...
				\\ \textbf{Gravità:} Alta.
				\\ \textbf{Descrizione:} Nessun membro del gruppo ha una conoscenza in tutte le tecnologie utilizzate nel 
			...
			\subsubsection{Malfunzionamento degli strumenti utilizzati}
				...
				\\ \textbf{Contromisure:} Il gruppo si impegna ad effettuare un backup periodicamente in modo da preventivare un'eventuale 
		...
		\subsection{Attualizzazione dei rischi}
			To fill with the most likely risks of each period.	
	
	\newpage 
	\section{Pianificazione}
		Considerando le scadenze elencate nella sezione 1.4 il gruppo ha deciso di suddividere il tempo a disposizione in 5 
		periodi:
		\begin{itemize}
			\item[1)] Approccio al capitolato;
			\item[2)] Esame più dettagliato;
			\item[3)] Sviluppo;
			\item[4)] Aggiunte e ulteriore sviluppo;
			\item[5)] Conclusione.
		\end{itemize}
		...
		\subsection{Approccio al capitolato}
			...
			di scadenza della consegna dei documenti necessari per la revisione.\\ 
			Le principali attività che il gruppo andrà a svolgere durante questo periodo sono:
			\begin{itemize}
				\item \textbf{Norme di progetto:} La prima attività svolta. Scritta dal'\emph{Amministratore}, serve a normare
			...
			\subsubsection{Gantt attività}
				...
				\begin{figure}[H]
					...
					\caption{Gantt attività - periodo di approccio al capitolato.}
				\end{figure}
			\subsubsection{WBS attività}
				...
				\begin{figure}[H]
					...
					\caption{Work Breakdown Structure - periodo di approccio al capitolato.}
				\end{figure}
			\subsubsection{Ripartizione ore}
				...
				\begin{figure}[H]
					...
					\caption{Ripartizione ore - periodo di approccio al capitolato.}
				\end{figure}

		\subsection{Esame più dettagliato}
			...
			prima scadenza che il gruppo intende rispettare e termina con l'inizio del periodo di sviluppo. 
			...
			\subsubsection{Gantt attività}
				...
				\begin{figure}[H]
					...
					\caption{Gantt attività - periodo di esame dettagliato.}
				\end{figure}
			\subsubsection{WBS attività}
				%Image
				\begin{figure}[H]
					...
					\caption{Work Breakdown Structure - periodo di esame dettagliato.}
				\end{figure}
			\subsubsection{Ripartizione ore}
				%Image
				\begin{figure}[H]
					...
					\caption{Ripartizione ore - periodo di esame dettagliato.}
				\end{figure}
		\subsection{Sviluppo}
			\textbf{Periodo:} da 2016-02-01 a 2016-03-20 \\
			Questo periodo inizia al termine di quello di esame dettagliato e termina con la conclusione 
			...
			Le attività che saranno svolte durante questo periodo sono:
			\begin{itemize}
			...
			\subsubsection{Gantt attività}
				...
				\begin{figure}[H]
					...
					\caption{Gantt attività - periodo di sviluppo.}
				\end{figure}
			\subsubsection{WBS attività}
				%Image
				\begin{figure}[H]
					...
					\caption{Work Breakdown Structure - periodo di sviluppo.}
				\end{figure}
			\subsubsection{Ripartizione ore}
				%Image
				\begin{figure}[H]
					...
					\caption{Ripartizione ore - periodo di sviluppo.}
				\end{figure}
				
		\subsection{Aggiunte e ulteriore sviluppo}
			\textbf{Periodo:} da 2016-03-21 a 2016-05-23 \\
			Questo periodo ha inizio immediatamente dopo la fine dello sviluppo, attraversa la seconda 
			...
			\emph{Revisione di qualifica}. \\Le attività principali di questo periodo sono:
			\begin{itemize}
			...
			\subsubsection{Gantt attività}
				...
				\begin{figure}[H]
					...
					\caption{Gantt attività - aggiunte e ulteriore sviluppo.}
				\end{figure}
			\subsubsection{WBS attività}
				%Image
				\begin{figure}[H]
					...
					\caption{Work Breakdown Structure - aggiunte e ulteriore sviluppo.}
				\end{figure}
			\subsubsection{Ripartizione ore}
				%Image
				\begin{figure}[H]
					...
					\caption{Ripartizione ore - aggiunte e ulteriore sviluppo.}
				\end{figure}
		\subsection{Conclusione}
			\textbf{Periodo:} da 2016-05-24 a 2016-06-19 \\
			Questo periodo porta a compimento l'intero progetto, è successivo alla \emph{Revisione di qualifica}. In questo periodo
			il gruppo intende effettuare gli ultimi test di verifica, e la validazione del prodotto. Come appena detto questo periodo porta 
			al completamente del progetto, si chiude infatti assieme all'ultima consegna che il gruppo intende rispettare: 
			\emph{Revisione di accettazione}. Durante questo periodo sono include due principali attività:
			\begin{itemize}
			...
			\subsubsection{Gantt attività}
				...
				\begin{figure}[H]
					...
					\caption{Gantt attività - conclusione.}
				\end{figure}
			\subsubsection{WBS attività}
				%Image
				\begin{figure}[H]
					...
					\caption{Work Breakdown Structure - conclusione.}
				\end{figure}
			\subsubsection{Ripartizione ore}
				%Image
				\begin{figure}[H]
					...
					\caption{Ripartizione ore - conclusione.}
				\end{figure}
	...
	\section{Suddivisione del lavoro}
		...
		\subsection{Totali}
			...
			\subsubsection{Totale ore rendicontate}
				...
				totali, in quanto non sono messe a carico del committente le ore appartenenti al periodo di \emph{Approccio al capitolato}: 
