...
\begin{document}
	...
	\mychapter{0}{Diario delle modifiche}
		\begin{table}[H]
			\begin{tabularx}{\textwidth}{sfmX}
				...
				\noalign{\hrule height 1.5pt}
				1.1.1 & 2016-01-11 & \emph{Amministratori} Maino Elia, Nicoletti Luca & Stesura norme commit e politiche di 
				ticketing, correzione errori  \\
				\noalign{\hrule height 0.5pt}
				1.1.0 & 2016-01-10 & \emph{Verificatori} Biggeri Mattia, Tommasin Davide & Verifica del documento  \\	
				\noalign{\hrule height 0.5pt}
				1.0.4 & 2016-01-09 & \emph{Amministratore} Nicoletti Luca & Stesura norme documentazione di pianificazione, correzione errori  \\	
				\noalign{\hrule height 0.5pt}
				1.0.3 & 2016-01-09 & \emph{Amministratore} Maino Elia & Stesura norme risoluzione problemi, versioning, comunicazioni
				e casi d'uso \\
				\noalign{\hrule height 0.5pt}
				1.0.3 & 2016-01-09 & \emph{Amministratore} Nicoletti Luca & Stesura norme Ticketing, Repository, Ruoli, Riunioni \\
				\noalign{\hrule height 0.5pt}
				1.0.2 & 2016-01-08 & \emph{Amministratore} Maino Elia & Stesura norme Documentazione\\
				\noalign{\hrule height 0.5pt}
				1.0.1 & 2016-01-08 & \emph{Amministratore} Nicoletti Luca & Stesura norme Studio di fattibilità e requisiti, 
	...
	\section{Scopo del documento}
		...
		Poichè il gruppo ha deciso di basarsi sulla struttura a processi \emph{ISO/IEC 12207}\ped{\textit{G}} 
	...
	\section{Riferimenti}
		\subsection{Informativi}
			\begin{itemize}
				...
				\item ISO/IEC 12207\ped{\textit{G}}: \\ \url{http://www.iso.org/iso/catalogue_detail?
				csnumber=43447}
	...
	I responsabili dello studio di fattibilità del progetto sono i membri che ricoprono il ruolo di 
	\emph{Analisti}. In base alle prime riunioni effettuate, decise dal \emph{Responsabile di progetto}, le 
	preferenze e le idee emerse per ogni singolo membro del gruppo, essi dovranno stendere il documento 
	(che verrà poi analizzato e valutato da altri 	membri del gruppo). Lo studio di fattibilità deve 
	contenere:
	\begin{itemize}
	...
	Sempre compito degli analisti, sarà quello di stilare l'analisi dei requisiti. Essi potranno ricavarli 
	da eventuali \emph{Casi d'uso} emersi da Brainstorming\ped{\textit{G}} o riunioni con il committente.
