...
\begin{document}
	...
	\mychapter{0}{Diario delle modifiche}
		Di seguito viene riportato il diario delle modifiche, in cui vengono elencate le modifiche 
		apportate al documento 
		stesso e da utilizzare come template in tutti gli altri documenti.
		\begin{table}[!h]
			\begin{tabularx}{\textwidth}{s f m X}
				\noalign{\hrule height 1.5pt}
				\rowcolor{orange!85} Versione & Data & Autore & Descrizione \\
				\noalign{\hrule height 0.5pt}
				1.1.0 & 2016-01-09 & Nicoletti Luca & Inserita la sezione 4.1.1 riguardante 
				\emph{ProjectLibre}, sistemati errori trovati durante la fase di verifica. \\				
				\noalign{\hrule height 0.5pt}
				1.0.4 & 2016-01-09 & Nicoletti Luca & Completata stesura documento, pronto per essere 
				verificato. \\
				\noalign{\hrule height 0.5pt}
				1.0.3 & 2016-01-09 & Maino Elia & Completamento stesura capitolo 3 ed integrazione capitoli 2 
				e 4 \\
				\noalign{\hrule height 0.5pt}
				...
				\noalign{\hrule height 0.5pt}
				1.0.0 & 2016-01-08 & Maino Elia + Nicoletti Luca & Creazione scheletro documento e struttura 
				organizzativa,
				 stesura capitolo 1 \\
				\noalign{\hrule height 1.5pt}
			\end{tabularx}
