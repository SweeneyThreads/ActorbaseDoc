...
diagrammi di package, sequenza e attività. \\
	...
	\section{Processi primari}
		...
		\subsubsection{Tecniche di tracciamento dei requisiti}
            ...
            Tutti i requisiti e Casi d'uso\ped{\emph{G}} saranno inseriti in un Database strutturato in modo funzionale dal gruppo. 
            ...
            \begin{itemize}
                ...
                \item segnare come completati i requisiti foglia; quando tutti i figli di un requisito sono marcati come completi, 
                anch'esso viene marcato come completato;
                \item per ogni requisiti è possibile scrivere delle note;
    ...
    delle sottodirectory: \verb|ActorbaseDoc/Documenti/Interni| e \verb|ActorbaseDoc/Documenti/Esterni|.
	\newline
    \textbf{LaTeX} \\
