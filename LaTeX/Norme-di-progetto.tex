...
\begin{document}
	...
	\begin{itemize}
		...
		\item \LaTeX\ped{\textit{G}}: \\ \url{https://www.latex-project.org}
		\item UML\ped{\textit{G}}: \\ \url{http://www.uml.org}
	...
	\subsection{Casi d'uso}
		Come detto in precedenza alcuni requisiti possono essere ricavati dai \emph{Casi d'uso}, ad essi si può fare
		 ...
		 \end{itemize}
		 A tale insieme di informazioni va associato un diagramma di caso d'uso in UML\ped{\textit{G}}. Per la scrittura dei
		  \emph{casi d'uso} in UML\ped{\textit{G}} il gruppo ha deciso di utilizzare il software StarUML alla versione più recente. La scelta è 
	...
	milestones presenti. 
	\\ \\ 
	Il Database verrà scritto utilizzando il linguaggio SQL\ped{\textit{G}} e l'ambiente mySQL disponibile gratuitamente.
	\\ \\
