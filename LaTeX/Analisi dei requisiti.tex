...
\begin{document}
	...
	\section*{Diario delle modifiche}
		\LTXtable{\textwidth}{Tabelle/tabelle_diario_modifiche/tabella_analisi.tex}
...
\end{itemize}
	...
	\newpage \section{Casi d'uso}
		...
		\subsection{Visione ad alto livello delle interazioni tramite interfaccia client}
		 	\begin{figure}[H]
				\centering
				\includegraphics[scale=0.23]{UC/"Actorbase client".png}
...
R[2.8.2.1][N][F]  \\
	 ...
	 \begin{figure}[H]
				\centering
				\includegraphics[scale=0.25]{UC/"UC 3-6 Rinomina database".png}
...
R[2.13.2.1][N][F]  \\
	 ...
	 \begin{figure}[H]
				\centering
				\includegraphics[scale=0.25]{UC/"UC 4-4 Rinomina mappa".png}
...
R[2.25.2][N][F]  \\
		 ...
		 \subsection{UC 10: Aggiunta utente}
		  \begin{figure}[H]
				\centering
				\includegraphics[scale=0.25]{UC/"UC 10 Aggiunta utente".png}
...
R[2.25.4][N][F]  \\
	...
	\begin{table}[H]
			\begin{tabularx}{\textwidth}{r X}
				...
				\textbf{Attori secondari} & Nessuno \\
				\noalign{\hrule height 0.5pt}
				\textbf{Pre-condizione} & L'amministratore intende aggiungere un utente e ha inserito il comando di aggiunta utente seguito dall'username\\
				\noalign{\hrule height 0.5pt}
...
R[2.25.4][N][F] \\
		 ...
		 \subsection{UC 11: Rimozione utente}
		  \begin{figure}[H]
				\centering
				\includegraphics[scale=0.3]{UC/"UC 11 Rimozione utente".png}
...
R[2.25.6][N][F]  \\
		 ...
		 \subsection{UC 12: Visualizzazione lista permessi utente}
		  \begin{figure}[H]
				\centering
				\includegraphics[scale=0.3]{UC/"UC 12 Visualizzazione lista permessi utente".png}
...
R[2.25.8][N][F] \\
	...
	\begin{table}[H]
			\begin{tabularx}{\textwidth}{r X}
				...
				\noalign{\hrule height 0.5pt}
				\textbf{Post-condizione} & L'amministratore ha inserito con successo il comando di visualizzazione lista permessi utente\\
				\noalign{\hrule height 0.5pt}
				\textbf{Flusso eventi} & \begin{enumerate}
...
R[2.25.8][N][F] \\
		 ...
		 \subsection{UC 13: Aggiunta permesso utente}
		  \begin{figure}[H]
				\centering
				\includegraphics[scale=0.3]{UC/"UC 13 Aggiunta permesso utente".png}
...
R[2.25.10][N][F]  \\
		 ...
		 \subsection{UC 14: Rimozione permesso utente}
		  \begin{figure}[H]
				\centering
				\includegraphics[scale=0.3]{UC/"UC 14 Rimozione permesso utente".png}
...
R[2.25.12][N][F]\\
	...
	\begin{table}[H]
			\begin{tabularx}{\textwidth}{r X}
				\textbf{Codice gerarchico} & UC14.2 \\
				\noalign{\hrule height 0.5pt}
...
R[2.25.12][N][F] \\
		 ...
		 \subsection{Visione ad alto livello delle interazioni tramite interfaccia server}
		 	\begin{figure}[H]
				\centering
				\includegraphics[scale=0.25]{UC/"Actorbase Server".png}
	...
	\end{table}
			...
			\subsection{Visione ad alto livello delle interazioni tramite driver}
		 	\begin{figure}[H]
				\centering
				\includegraphics[scale=0.3]{UC/"Actorbase Driver".png}
...
R[3.1.1][N][F]  \\
	...
	\LTXtable{\textwidth}{Tabelle/tabelle_requisiti/funzionali.tex}
	...
	\LTXtable{\textwidth}{Tabelle/tabelle_requisiti/vincolo.tex}
	...
	\LTXtable{\textwidth}{Tabelle/tabelle_requisiti/qualita.tex}
	...
	%\LTXtable{\textwidth}{Tabelle/tabelle_requisiti/prestazionali.tex}
	
	\subsection{Tracciamento fonti-requisiti}
	Di seguito si riporta in forma tabellare il tracciamento tra le fonti e i requisiti.
	\LTXtable{\textwidth}{Tabelle/tabelle_requisiti/fontirequisiti.tex}
	
	\subsection{Tracciamento requisiti-fonti}
	Di seguito si riporta in forma tabellare il tracciamento tra i requisiti e le fonti.
	\LTXtable{\textwidth}{Tabelle/tabelle_requisiti/requisitifonti.tex}
