...
\end{enumerate}				 \\
	...
	\textbf{Descrizione} 
	\\ \\
	L'utente ha effettuato correttamente la connessione e ha selezionato un database di cui dispone dei permessi di accesso. Su tale database può effettuare diverse operazioni a livello di mappa:
	\begin{itemize}
	...
	\item Selezionare una mappa per effettuare operazioni a livello di item su di essa
...
\end{enumerate}				 \\
				...
				\end{itemize} 
			\end{tabularx}
			\caption{Caso d'uso UC 4 - Operazioni sulle mappe}
		 \end{table} 
	...
	\begin{table}[H]
			\begin{tabularx}{\textwidth}{r X}
				...
				\textbf{Attori secondari} & Nessuno \\
				\noalign{\hrule height 0.5pt}
				\textbf{Pre-condizione} & L'utente intende rinominare una mapa e ha inserito il comando di rinominazione mappa seguito dal nome della mappa da rinominare\\
				\noalign{\hrule height 0.5pt}
...
L'utente avente i permessi di amministratore, vuole visualizzare i permessi di altri utenti. Ha a disposizione due possibilità: 
	\begin{itemize}
		\item Visualizzare a lista dei permessi relativi all'intero database
	...
	\begin{table}[H]
	 ...
	 \textbf{Descrizione}
	 \\ \\
	 L'utente sta effettuando l'operazione di visualizzazione dei permessi di uno specifico utente.
	\begin{table}[H]
			\begin{tabularx}{\textwidth}{r  X}
...
L'utente avente i permessi di amministratore, vuole modificare i permessi di amministrazione, scrittura, lettura di un utente.
	...
	\textbf{Descrizione} 
	\\ \\
	L'utente ha richiesto un accesso ad una mappa non presente nel database, l'accesso è fallito e l'utente riceve un messaggio di errore informativo e la può inserire un nuovo comando.
	\begin{table}[H]
			\begin{tabularx}{\textwidth}{r X}
