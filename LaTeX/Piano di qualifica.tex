...
\end{itemize}
					\begin{table}[H]
						\begin{tabularx}{\textwidth}{L P P P P P}
							\noalign{\hrule height 1.5pt}
							\rowcolor{orange!85} Documento & Gulpease & parole & figure per pagina & parole per section & errori ortografici\\
							\noalign{\hrule height 1.5pt}
		...
		\begin{table}[H]
			\begin{tabularx}{\textwidth}{m f f X}
				\noalign{\hrule height 1.5pt}
				\rowcolor{orange!85} File & Media Complessità Ciclomatica & Massima Complessità Ciclomatica\\
				\noalign{\hrule height 1.5pt}
					Parser & 6 & 11\\
				\noalign{\hrule height 0.5pt}
					Client & 3 & 3\\
		...
		\begin{table}[H]
			\begin{tabularx}{\textwidth}{L P L L L}
				\noalign{\hrule height 1.5pt}
				\rowcolor{orange!85} File & Param. per classe & Max param. per metodo &  Media param. per metodo & Numero metodi\\
				\noalign{\hrule height 1.5pt}
					Parser & 0 & 4 & 2 & 8 \\
				\noalign{\hrule height 0.5pt}
					Client & 1 & 1 & 1 & 2 \\
	...
	\subsection{Test di integrazione}
		...
		\LTXtable{\textwidth}{Tabelle/tabelle_test/test_integrazione_requisiti.tex}
