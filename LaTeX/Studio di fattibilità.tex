...
\begin{document}
	...
	\section*{Diario delle modifiche}
		\LTXtable{\textwidth}{Tabelle/tabelle_diario_modifiche/tabella_sf.tex}
	...
	\subsubsection{Informativi}	
		\begin{itemize}
			\item \textbf{Capitolato d'appalto C1:} Actorbase: a NoSQL DB based on the Actor\ped{\emph{G}} model \\
	...
	\section{Scelta del capitolato C1}
		\subsection{Descrizione del capitolato}
			...
			\begin{itemize}
				...
				\item L'utilizzo del linguaggio Scala\ped{\emph{G}} o Java;
		...
		\subsection{Criticità potenziali e costi}
			...
			\begin{itemize}
				...
				\item \textbf{Scala:} il linguaggio consigliato per lo sviluppo del progetto risulta essere Scala\ped{\emph{G}}, 
				nessun componente del gruppo possiede padronanza in tale linguaggio, essa andrà dunque 
				acquisita prima della fase\ped{\emph{G}} di progettazione;
				\item \textbf{Modello ad attori e libreria Akka\ped{\emph{G}}:} i componenti del gruppo conoscono
				 ...
				 uno studio completo che dovrà avvenire prima della fase\ped{\emph{G}} di progettazione;
		...
		\subsection{Considerazioni e valutazioni finali}
			...
			\subsubsection{Aspetti positivi}
				\begin{itemize}
					...
					acquisire competenze utili nel proseguimento della carriera, come Scala\ped{\emph{G}} e i database NoSQL;
					\item \textbf{Curiosità nei confronti del linguaggio di programmazione:} il progetto permette 
					di prendere confidenza con un linguaggio di programmazione moderno come Scala\ped{\emph{G}}.
		...
		\subsection{C2 - CLIPS}
			\subsubsection{Valutazione generale}
				...
				\begin{itemize}
					...
					\item la tecnologia imposta presenta instabilità e immaturità, è infatti ancora in fase\ped{\emph{G}} di sviluppo.
				\end{itemize}
			\subsubsection{Potenziali criticità}
				...
				Questo potrebbe portare a modifiche di implementazione in fase\ped{\emph{G}} di sviluppo, che potrebbero richiedere di effettuare tabula rasa di ciò 
